 ...
 */
public class ByteArrayWritableByteChannelFollower implements AioFollower<Void> {
   private final WritableByteChannel channel;
   private final ByteBuffer content;

   public ByteArrayWritableByteChannelFollower(WritableByteChannel channel, byte[] bytes) {
